      ...
      <div className="flex flex-col bg-[white] justify-center items-center pb-[171px] pt-[81px] lg:px-[90px] md:px-[50px] px-[30px] max-w-[630px] mx-auto text-center ">
        ...
        >
          ...
          <div class="flex items-center ">
            <input type="radio" className="h-5 w-5 mr-3 border border-[#E2E8F0] " />
        ...
        >
          ...
          <button type="submit" class="py-4 items-center rounded-[20px] w-[427px] my-[32px] bg-[#124072] text-[#ffffff] text-[16px] leading-[24px] tracking-[0.2px] font-extrabold flex justify-center ">
            Sign In {isLoading && (<svg
