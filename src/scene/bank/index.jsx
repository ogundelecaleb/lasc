      ...
      <div className="lg:flex lg:justify-between items-center mb-8 ">
        ...
        <div className="flex items-center ">
          <button
            ...
            className=" px-4 py-2 bg-[#124072] text-[white] text-[14px] h-[48px] leading-[21px] tracking-[0.2px] font-extrabold rounded-xl flex items-center mr-4 "
          >
            <svg
              className="mr-1"
              width="16"
        ...
        <table className="min-w-full mb-6">
          ...
          <tbody>
            <tr className="mb-2">
              ...
              <td className="text-center py-[28px] pr-3 border-t border-[#EDF2F7] text-[16px] leading-[24px] tracking-[0.2px] text-[#1A202C] font-medium text-left  ">
                82e98
              </td>
